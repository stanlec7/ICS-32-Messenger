...
class Profile:
    ...
    def add_opened_profiles(self, openPfUser:str):
        self.opened_profiles.append(openPfUser)
        print("my open list",self.opened_profiles)
    
    def get_opened_profiles(self):
        return self.opened_profiles

   
    '''
    def add_opened_profiles(self, openPf:Profile):
        self.opened_profiles.append(openPf)
    ...
    def get_posts(self) -> list[Post]:
        #print("profile module get_posts", self._posts)
        return self._posts
    ...
    def save_profile(self, path: str) -> None:
        ...
        if os.path.exists(p) and p.suffix == '.dsu':
            try:
                ...
                print("inside new save pf",self.opened_profiles)
                f.close()
    ...
    """
    #def load_profile(self, path: str,dsu:str,usr:str, pwd:str) -> None:
    def load_profile(self, path: str) -> None:
        ...
        if os.path.exists(p) and p.suffix == '.dsu':
            try:
                ...
                self.opened_profiles=obj['opened_profiles']
                #self.bio = obj['bio']
